...
public class ProductRepositoryImpl {
    ...
    public ProductCatalog updateProduct(ProductCatalog newProduct) {
        ...
        ProductCatalog current = repository.
            findOneByActiveAndKey(newProduct.isActive(), newProduct.getKey());
        if (current == null) {
            throw new IllegalStateException("Prodct key altered. No existing versionFound");
        } else {
